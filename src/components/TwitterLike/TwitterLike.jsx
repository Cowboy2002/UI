...
//import './style.css';
import "components/TwitterLike/style.scss";

class TwitterLike extends React.Component {
  render() {
    return (
    <div className="main-content">
      <svg className="heart-svg" viewBox="467 392 58 57" xmlns="http://www.w3.org/2000/svg">
        <g className="Group" fill="none" fill-rule="evenodd" transform="translate(467 392)">
